...
public class TankRoleService {
    ...
    public List<TankRole> findAll() {
        return this.tankRoleRepository.findAll();
    }
    ...
    public TankRole create(TankRole tankRole) {
        ...
        return this.tankRoleRepository.save(tankRole);
    }

    public TankRole update(TankRole tankRole) {
        if (!this.tankRoleRepository.existsById(tankRole.getId())) {
    ...
    public void deleteById(Long id) {
        this.tankRoleRepository.deleteById(id);
    }
}
